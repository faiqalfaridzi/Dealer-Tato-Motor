...
<html>
    ...
    <header style=" background: white;">
        <div class="col-12 topnav">
            ...
            <a href="owner_login.php" style="padding-right:0;color: white;text-decoration:none; color: inherit;float:right;">Login/Daftar
                <span class="fas fa-sign-in fa-lg"> </span>
            </a>         
        </div>
        ...
        <div class="col-12 bottomnav"style="display: flex; align-items: center; /* Vertical center alignment */justify-content: center; ">
            <div>
                <a href="index.php" style="padding-right:0;text-decoration:none; color: black;margin-right:0">Home</a>
                <select class="ml-2" onchange="javascript:handleSelect(this)" style="text-align: center; text-align-last: center;-moz-text-align-last: center;">
                    ...
                    <option value="user_jual" value="Matic" style="font-size:14px;">Jual</option>
                    <option value="user_beli"  style="font-size:14px;">Beli</option>
                </select>
                <a href="user_terjual.php" style="padding-right:0;text-decoration:none; color: black;">Unit Terjual</a>
            </div>
        </div>
    </header>
    <body>
