...
<?php 
include('komponen/head_owner.php');
?>
<style>
      ...
      <div class="col-6">
        <div class="card">          
          <div class="card-body text-center">
            <form method="post" action="owner_cek_login.php" enctype="multipart/form-data">
              <div class="mb-3">
                <label for="username" class="form-label"><strong>Login Owner</strong></label>
