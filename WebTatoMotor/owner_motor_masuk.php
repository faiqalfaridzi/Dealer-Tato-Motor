...
<div class="container mt-5">
    <div class="row">
        <?php 
            $query   = "SELECT * FROM penjualan WHERE status_motor='belum terima' ORDER BY id_motor DESC";
            ...
            <div class='col-sm-12 text-center' style='padding-left:0;'>                        
                <a role='button' href='owner_terima.php?id_motor=".$results['id_motor']."' class='btn btn-success'>Terima</a>
                <a role='button' href='owner_hapus.php?id_motor=".$results['id_motor']."' class='btn btn-danger'>Tolak</a>
            </div>
            </a>
        </div>
        ";}
